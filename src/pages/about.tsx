...
const About = () => {
    ...
    const saveFile = () => {
        saveAs(
            "https://www.cakeresume.com/pdf/s--VKnOevPDXKyPE-WHCxssYQ--/7baYb.pdf",
            "Robby.pdf"
        );
    };
    return (
                ...
                <div className={Style.content}>
                    ...
                    <div className={Style.personal}>
                        <ul>
                            ...
                            <li>
                                {t("About_langages")} : <span>{t("About_Chinese_English")} </span>
                            </li>
                        </ul>
                        <ul>
                            <li>
                ...
                <ul>
                    <li>
                        ...
                        <div className={Style.experience_content}>
                            ...
                            <h3>{t("Aboit_EXPERIENCE_COMPANY")}</h3>
                            <p>{t("Aboit_EXPERIENCE_CONTENT1")}</p>
                            <p>{t("Aboit_EXPERIENCE_CONTENT2")}</p>
                        </div>
                    </li>
                    <li>
                        <div className={Style.icon}>
